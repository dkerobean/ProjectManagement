...
const _UserDropdown = () => {
    ...
    const userId = (session?.user as ExtendedUser & { id?: string })?.id
    ...
    // Create avatar props without the key prop to avoid React warning
    const createAvatarProps = (size?: number) => ({
        size: size || 32,
        ...(avatarUrl
            ? { src: avatarUrl }
            : { icon: <PiUserDuotone /> }),
        ...
        <Dropdown
            ...
            renderTitle={
                <div className="cursor-pointer flex items-center">
                    <Avatar key={avatarKey} {...createAvatarProps(32)} />
                </div>
            }
        ...
        >
            <Dropdown.Item variant="header">
                <div className="py-2 px-3 flex items-center gap-3">
                    <Avatar key={avatarKey} {...createAvatarProps()} />
                    <div>
