    ...
    <div className="min-h-screen bg-black text-white pb-24 relative overflow-hidden font-sans">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 pb-safe">
        ...
        <div className="relative max-w-lg mx-auto flex justify-around items-center h-16 px-2">
          ...
          <a href="/gold/suppliers" className="flex flex-col items-center justify-center w-16 h-full gap-1 text-amber-400">
            <span className="text-xl drop-shadow-[0_0_8px_rgba(251,191,36,0.5)]">👥</span>
            <span className="text-[10px] font-bold">People</span>
          </a>
          <a href="/gold/reports" className="flex flex-col items-center justify-center w-16 h-full gap-1 text-gray-500 hover:text-white transition-colors">
            <span className="text-xl opacity-70">📊</span>
